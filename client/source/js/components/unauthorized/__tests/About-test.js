...
describe("About Component", () => {
    ...
    it("should contain text", (done) => {
        expect(shallow(<About />).contains(<p>Want to help out? Need help? Spark is a free service to match volunteer-based organizations with people who wants to help. Register as a volunteer, let us know how often you want to help
